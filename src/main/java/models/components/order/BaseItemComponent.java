...
public class BaseItemComponent extends Component {
    private static final By barNotification = By.id("bar-notification");
    ...
    public void waitUntilItemAddedToCart(){
        ...
        wait.until(ExpectedConditions.textToBePresentInElementLocated(barNotification, successMsg));
    }
}
